...
public static class ExecutableCollisionAlgorithms
{
	...
	private sealed class Detach_Collisions_Geometry3D_SphereTriangle_Sphere_Triangle3D_IntersectionResult_ : IExecutableCollisionAlgorithm
	{
		public string Name => "Detach.Collisions.Geometry3D.SphereTriangle(Sphere,Triangle3D,IntersectionResult)";
