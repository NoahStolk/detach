...
public static class VectorExtensions
{
	...
	public static bool IsReal(this Vector2 vector)
		=> MathUtils.IsFloatReal(vector.X) && MathUtils.IsFloatReal(vector.Y);

	public static bool IsReal(this Vector3 vector)
		=> MathUtils.IsFloatReal(vector.X) && MathUtils.IsFloatReal(vector.Y) && MathUtils.IsFloatReal(vector.Z);

	public static bool IsReal(this Vector4 vector)
		=> MathUtils.IsFloatReal(vector.X) && MathUtils.IsFloatReal(vector.Y) && MathUtils.IsFloatReal(vector.Z) && MathUtils.IsFloatReal(vector.W);
}
